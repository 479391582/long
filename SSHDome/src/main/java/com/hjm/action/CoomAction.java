...
public class CoomAction extends GonggoAction{
	...
	//查询商品
		...
		String urlNameString="http://pangyan-123.gnway.cc/DongMaven/commodity/all";
		String result="";
		try {
			//根据地址获取请求
		...
		String urlNameString="http://pangyan-123.gnway.cc/DongMaven/commodity/oneselect?cid=id";
		String result="";
		try {
			//根据地址获取请求
			HttpGet request=new HttpGet(urlNameString);
		...
		//添加购物车
				...
				String urlNameString="http://pangyan-123.gnway.cc/DongMaven/shop/save?cid=shop.cid&cname=c.cname";
		...
		//查询购物车
			public void sall() throws Exception{
					System.out.println("查询购物车");
					 session = request.getSession();
						String cname = (String) session.getAttribute("username");
				String urlNameString="http://pangyan-123.gnway.cc/DongMaven/shop/nameall?cname=c.cname";
				urlNameString=urlNameString.replace("c.cname",cname);
			...
			String urlNameString="http://pangyan-123.gnway.cc/DongMaven/shop/del?shid=shop.shid";
			...
			public String delall() throws Exception{
				System.out.println("删除");
				 session = request.getSession();
					String cname = (String) session.getAttribute("username");
			String urlNameString="http://pangyan-123.gnway.cc/DongMaven/shop/onealldelect?cname=shop.cname";
			...
			String urlNameString="http://pangyan-123.gnway.cc/DongMaven/commOrder/save?shid=shop.shid&cname=c.cname&cphone=p.phone";
			urlNameString=urlNameString.replace("shop.shid",shid);
			urlNameString=urlNameString.replace("c.cname",cname);
			...
			public void dingdan() throws Exception{
					System.out.println("查询订单");
					 session = request.getSession();
						String cname = (String) session.getAttribute("username");
				String urlNameString="http://pangyan-123.gnway.cc/DongMaven/commOrder/nameall?cname=c.cname";
				urlNameString=urlNameString.replace("c.cname",cname);
