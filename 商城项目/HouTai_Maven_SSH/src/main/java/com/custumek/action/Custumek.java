...
public class Custumek extends CommonAction{
	...
	public String getall() throws Exception {
		...
		if (totalPage==null) {
			urlNameString = "http://127.0.0.1:8080/DongMaven/t_CUSTUMER/page";
		}else {
			urlNameString = "http://127.0.0.1:8080/DongMaven/t_CUSTUMER/page?currentPage="+totalPage+"";
		}
		String result="";
		try {
			// 根据地址获取请求
	...
	public String tzupd() throws Exception {
		...
		String urlNameString = "http://127.0.0.1:8080/DongMaven/t_CUSTUMER/oneselect?cid="+cid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void upd() throws Exception {
		...
		String urlNameString = "http://127.0.0.1:8080/DongMaven/t_CUSTUMER/update?cid="+cid+"&cname="+cname+"&cpwd="+cpwd+"&crealname="+crealname+"&cphone="+cphone+"&status="+status+"&address="+address+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void add() throws Exception {
		...
		String status=request.getParameter("status");
		String address=request.getParameter("address");
		String urlNameString = "http://127.0.0.1:8080/DongMaven/t_CUSTUMER/save?cname="+cname+"&cpwd="+cpwd+"&crealname="+crealname+"&cphone="+cphone+"&status="+status+"&address="+address+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void del() throws Exception {
		String cid=request.getParameter("cid");
		String urlNameString = "http://127.0.0.1:8080/DongMaven/t_CUSTUMER/del?cid="+cid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
