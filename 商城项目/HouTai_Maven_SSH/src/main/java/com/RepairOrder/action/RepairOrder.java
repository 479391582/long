...
public class RepairOrder extends CommonAction{
	...
	public void caozuo() throws IOException {
		...
		String urlNameString = "http://127.0.0.1:8080/DongMaven/repairOrder/oneselect?reid="+reid+"";
		String result="";
		try {
			// 根据地址获取请求
		...
		urlNameString = "http://127.0.0.1:8080/DongMaven/repairOrder/update?reid="+reid+"&status="+status+"";
		result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public String getall() throws Exception {
		...
		if (totalPage==null) {
			urlNameString = "http://127.0.0.1:8080/DongMaven/repairOrder/page";
		}else {
			urlNameString = "http://127.0.0.1:8080/DongMaven/repairOrder/page?currentPage="+totalPage+"";
		}
		String result="";
		try {
			// 根据地址获取请求
	...
	public void upd() throws Exception {
		...
		String urlNameString = "http://127.0.0.1:8080/DongMaven/repairOrder/update?rtype="+rtype+"&rbrand="+rbrand+"&fault="+fault+"&remarks="+remarks+"&status="+status+"&cname="+cname+"&cphone="+cphone+"&reid="+reid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void add() throws Exception {
		...
		String cname=request.getParameter("cname");
		String cphone=request.getParameter("cphone");
		String urlNameString = "http://127.0.0.1:8080/DongMaven/repairOrder/save?rtype="+rtype+"&rbrand="+rbrand+"&fault="+fault+"&remarks="+remarks+"&status="+status+"&cname="+cname+"&cphone="+cphone+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void del() throws Exception {
		String reid=request.getParameter("reid");
		String urlNameString = "http://127.0.0.1:8080/DongMaven/repairOrder/del?reid="+reid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
