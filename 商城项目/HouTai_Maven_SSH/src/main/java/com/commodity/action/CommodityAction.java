...
public class CommodityAction extends CommonAction{
	...
	public String getall() throws Exception {
		...
		if (totalPage==null) {
		urlNameString = "http://127.0.0.1:8080/DongMaven/commodity/page";
		}else {
			urlNameString = "http://127.0.0.1:8080/DongMaven/commodity/page?currentPage="+totalPage+"";
		}
		String result="";
		try {
			// 根据地址获取请求
	...
	public String tzupd() throws Exception {
		...
		String urlNameString = "http://127.0.0.1:8080/DongMaven/commodity/oneselect?cid="+cid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void upd() throws Exception {
		...
		String urlNameString = "http://127.0.0.1:8080/DongMaven/commodity/update?cname="+cname+"&cprice="+cprice+"&fid="+fid+"&ctype="+ctype+"&cbrand="+cbrand+"&describe="+describe+"&cid="+cid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void add() throws Exception {
		...
		String cbrand=request.getParameter("cbrand");
		String describe=request.getParameter("describe");
		String urlNameString = "http://127.0.0.1:8080/DongMaven/commodity/save?cname="+cname+"&cprice="+cprice+"&fid="+fid+"&ctype="+ctype+"&ctype="+ctype+"&cbrand="+cbrand+"&describe="+describe+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void del() throws Exception {
		String cid=request.getParameter("cid");
		String urlNameString = "http://127.0.0.1:8080/DongMaven/commodity/del?cid="+cid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
