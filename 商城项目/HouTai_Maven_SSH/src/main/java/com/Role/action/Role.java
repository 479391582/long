...
public class Role extends CommonAction{
	...
	public String getall() throws Exception {
		...
		if (totalPage==null) {
			urlNameString = "http://127.0.0.1:8080/DongMaven/t_ROLE/page";
		}else {
			urlNameString = "http://127.0.0.1:8080/DongMaven/t_ROLE/page?currentPage="+totalPage+"";
		}
		String result="";
		try {
			// 根据地址获取请求
	...
	public String tzupd() throws Exception {
		...
		String urlNameString = "http://127.0.0.1:8080/DongMaven/t_ROLE/oneselect?rid="+rid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void upd() throws Exception {
		...
		String urlNameString = "http://127.0.0.1:8080/DongMaven/t_ROLE/update?rid="+rid+"&rname="+rname+"&rdescribe="+rdescribe+"&fid="+fid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void add() throws Exception {
		...
		String rdescribe=request.getParameter("rdescribe");
		String fid=request.getParameter("fid");
		String urlNameString = "http://127.0.0.1:8080/DongMaven/t_ROLE/save?rname="+rname+"&rdescribe="+rdescribe+"&fid="+fid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void del() throws Exception {
		String rid=request.getParameter("rid");
		String urlNameString = "http://127.0.0.1:8080/DongMaven/t_ROLE/del?rid="+rid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
