...
public class LoginAction extends CommonInformaAction{
	...
	String urlNameString="http://127.0.0.1:8080/DongMaven/t_CUSTUMER/login?cname=custumer.cname&cpwd=custumer.cpwd";
	...
	public void save() throws Exception{
		...
		String url="http://127.0.0.1:8080/DongMaven/repairOrder/save?rtype=repairOrder.rtype&rbrand=repairOrder.rbrand&fault=repairOrder.fault&remarks=repairOrder.remarks&cname=repairOrder.cname&cphone=repairOrder.cphone";
		...
		url="http://127.0.0.1:8080/DongMaven/t_CUSTUMER/update?cid="+cid+"&address="+address+"";
		result="";
		try {
			//根据地址获取请求						
			HttpGet request=new HttpGet(url);
