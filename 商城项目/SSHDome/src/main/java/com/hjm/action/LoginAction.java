...
public class LoginAction extends GonggoAction{
	...
	String urlNameString="http://127.0.0.1:8080/DongMaven/t_CUSTUMER/save?cname=custumer.cname&cpwd=custumer.cpwd&crealname=custumer.crealname&cphone=custumer.cphone&address=custumer.address";
	urlNameString=urlNameString.replace("custumer.cname",cname);
	urlNameString=urlNameString.replace("custumer.cpwd",cpwd);
