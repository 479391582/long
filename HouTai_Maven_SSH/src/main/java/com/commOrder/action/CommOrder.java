...
public class CommOrder extends CommonAction{
	...
	public void caozuo() throws IOException {
		...
		String urlNameString = "http://pangyan-123.gnway.cc/DongMaven/commOrder/oneselect?coid="+coid+"";
		String result="";
		try {
			// 根据地址获取请求
		...
		urlNameString = "http://pangyan-123.gnway.cc/DongMaven/commOrder/update?coid="+coid+"&status="+status+"";
		result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public String getall() throws Exception {
		...
		if (totalPage==null) {
		urlNameString = "http://pangyan-123.gnway.cc/DongMaven/commOrder/page";
		}else {
			urlNameString = "http://pangyan-123.gnway.cc/DongMaven/commOrder/page?currentPage="+totalPage+"";
		}
		String result="";
		try {
			// 根据地址获取请求
	...
	public void upd() throws Exception {
		...
		String urlNameString = "http://pangyan-123.gnway.cc/DongMaven/commOrder/update?coname="+coname+"&coprice="+coprice+"&cotype="+cotype+"&cobrand="+cobrand+"&status="+status+"&cname="+cname+"&cphone="+cphone+"&coid="+coid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void add() throws Exception {
		...
		String cname=request.getParameter("cname");
		String cphone=request.getParameter("cphone");
		String urlNameString = "http://pangyan-123.gnway.cc/DongMaven/commOrder/save?coname="+coname+"&coprice="+coprice+"&cotype="+cotype+"&cobrand="+cobrand+"&status="+status+"&cname="+cname+"&cphone="+cphone+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public String tzditu() throws IOException {
		...
		String urlNameString = "http://pangyan-123.gnway.cc/DongMaven/t_CUSTUMER/oneselect?cid="+weizhi+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
	...
	public void del() throws Exception {
		String coid=request.getParameter("coid");
		String urlNameString = "http://pangyan-123.gnway.cc/DongMaven/commOrder/del?coid="+coid+"";
		String result="";
		try {
			// 根据地址获取请求
			HttpGet request = new HttpGet(urlNameString);//这里发送get请求
